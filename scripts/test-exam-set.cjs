...
(async()=>{
  ...
  try{
    ...
    assert(await page.locator('#delivery-email').getAttribute('required')!==null);
    assert(await page.locator('#subject').isDisabled());
    assert.equal(await page.locator('#mode').inputValue(),'assessment');
