  ...
  window.computerApplicationOverview=function(){
    ...
    return '<div class="ca-version">'+sp('<b>Pilot version:</b> Windows 11 + Microsoft 365 / Office 2024','<b>पायलट संस्करण:</b> Windows 11 + Microsoft 365 / Office 2024')+'</div>'+
      ...
      '<section class="ca-roadmap" aria-labelledby="ca-roadmap-title">'+
        '<div class="ca-roadmap-head"><div><span class="eyebrow">'+sp('Complete learning path','पूरा learning path')+'</span><h3 id="ca-roadmap-title">'+sp('Planned lessons in every stage','हर stage के planned lessons')+'</h3></div><p>'+sp('All ten Basic chapters are available below. Diploma and Advanced Diploma lessons show the planned sequence for future chapters.','सभी दस Basic chapters नीचे उपलब्ध हैं। Diploma और Advanced Diploma lessons आगे आने वाले chapters का planned sequence दिखाते हैं।')+'</p></div>'+
