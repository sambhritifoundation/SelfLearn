  ...
  window.computerApplicationOverview=function(){
    ...
    return '<div class="ca-version">'+sp('<b>Pilot version:</b> Windows 11 + Microsoft 365 / Office 2024','<b>पायलट संस्करण:</b> Windows 11 + Microsoft 365 / Office 2024')+'</div>'+
      ...
      '<section class="ca-roadmap" aria-labelledby="ca-roadmap-title">'+
        '<div class="ca-roadmap-head"><div><span class="eyebrow">'+sp('Complete learning path','पूरा learning path')+'</span><h3 id="ca-roadmap-title">'+sp('Planned lessons in every stage','हर stage के planned lessons')+'</h3></div><p>'+sp('The first three Basic chapters are available below. Diploma and Advanced Diploma lessons show the planned sequence for future chapters.','पहले तीन Basic chapters नीचे उपलब्ध हैं। Diploma और Advanced Diploma lessons आगे आने वाले chapters का planned sequence दिखाते हैं।')+'</p></div>'+
        '<div class="ca-plan-grid">'+
          '<article class="ca-plan-card active"><div class="ca-plan-title"><span>🌱</span><div><h4>'+sp('Basic Certificate','बेसिक सर्टिफिकेट')+'</h4><span class="ca-available">'+sp('Chapters 1–3 available','Chapters 1–3 उपलब्ध')+'</span></div></div>'+lessonList(basic)+'</article>'+
