...
/* Extracted from the supplied JAC Class 10 Science Theory Annual 2026 source.
   The available paper pages contain Section A, Questions 1-29; Question 30 was not present. */
(() => {
  const source='JAC Class 10 Science (Theory) Annual 2026, Section A';
  const rows=[
  ...
  rows.forEach((r,i)=>window.EXAMPREP.questions.push({qid:'EP-JAC-10-S-2026-A-'+String(i+1).padStart(2,'0'),class:'10',subject:'Science',topic:r[0],subTopic:r[1],question:r[2],options:r[3],correct:r[4],difficulty:'PYQ',explanation:r[5],imageUrl:'',type:'mcq',marks:1,sourceType:'JAC PYQ 2026',sourceRef:`${source}, Q${i+1}`}));
})();

/* Hindi companion text for the Mathematics PYQ 2026 questions. */
(() => {
  const q=window.EXAMPREP.questions.filter(x=>x.subject==='Maths'&&x.sourceType==='JAC PYQ 2026');
  const rows=[
    ['अभाज्य गुणनखंडन','5005 का अभाज्य गुणनखंडन कौन-सा है?',['6 × 7 × 11 × 13','5 × 7 × 11 × 7 × 13','5 × 7 × 11 × 13','इनमें से कोई नहीं'],'5005 = 5 × 1001 = 5 × 7 × 11 × 13।'],
    ['महत्तम समापवर्तक','दो क्रमागत धनात्मक पूर्णांकों का महत्तम समापवर्तक क्या है?',['0','1','3','इनमें से कोई नहीं'],'क्रमागत पूर्णांकों का 1 के अतिरिक्त कोई समान गुणनखंड नहीं होता।'],
    ['परिमेय संख्याएँ','निम्नलिखित में कौन-सी परिमेय संख्या है?',['√1764','0.010010001…','π','इनमें से कोई नहीं'],'√1764 = 42 है, जो परिमेय संख्या है।'],
    ['बहुपद के शून्यक','दिए गए y = p(x) के ग्राफ में p(x) के कितने शून्यक हैं?',['2','3','1','4'],'वक्र x-अक्ष को चार बिंदुओं पर काटता है, इसलिए चार शून्यक हैं।'],
    ['शून्यकों और गुणांकों का संबंध','x² − 7x + 12 के शून्यकों का योग क्या है?',['6','7','−7','12'],'ax² + bx + c के शून्यकों का योग −b/a होता है; यहाँ यह 7 है।'],
    ['संगति','यदि 4x + 3y = 5 और 2x + ky = 1 असंगत हों, तो k का मान क्या है?',['1','2','4','3/2'],'असंगत समीकरणों के लिए a₁/a₂ = b₁/b₂ ≠ c₁/c₂; अतः k = 3/2।'],
    ['समीकरण युग्म का हल','2x + y = 6 और 5x − y = 1 का हल क्या है?',['x = 4, y = 3','x = 1, y = 4','x = 4, y = 1','x = −1, y = 8'],'दोनों समीकरण जोड़ने पर 7x = 7, इसलिए x = 1 और y = 4।'],
    ['द्विघात समीकरण की पहचान','निम्नलिखित में कौन-सा द्विघात समीकरण है?',['(x − 3)² = x² − 7x + 5','(x + 1)² = x² − 5x + 7','(x + 1)² = 2(x − 3)','x² + 4x + 1 = (x + 3)²'],'केवल विकल्प C सरल करने पर घात 2 का समीकरण देता है।'],
    ['विविक्तकर','2x² − 8x + 4 = 0 का विविक्तकर क्या है?',['32','64','96','92'],'D = b² − 4ac = (−8)² − 4(2)(4) = 32।'],
    ['सार्व अंतर','समांतर श्रेढ़ी 0.6, 1.7, 2.8, 3.9, … का सार्व अंतर क्या है?',['1.1','11','0.6','6'],'दो क्रमागत पदों का अंतर 1.7 − 0.6 = 1.1 है।'],
    ['nवाँ पद','समांतर श्रेढ़ी 2, 7, 12, … का दसवाँ पद क्या है?',['245','47','52','57'],'a₁₀ = 2 + 9(5) = 47।'],
    ['दूरी सूत्र','(2, 3) और (5, 7) के बीच की दूरी क्या है?',['4','3','5','इनमें से कोई नहीं'],'√[(5−2)² + (7−3)²] = √25 = 5।'],
    ['विभाजन सूत्र','(2, 5) और (4, 7) को जोड़ने वाले रेखाखंड का मध्यबिंदु क्या है?',['(1, 2)','(5/2, 7/2)','(3, 7)','(3, 6)'],'मध्यबिंदु ((2+4)/2, (5+7)/2) = (3, 6) है।'],
    ['समरूप त्रिभुज','समरूप त्रिभुजों की संगत भुजाएँ कैसी होती हैं?',['समान','समानुपाती','पूरक','संपूरक'],'संगत भुजाओं के प्रत्येक युग्म का अनुपात समान होता है।'],
    ['मूल समानुपात प्रमेय','ΔABC में DE ∥ BC है। यदि BD = 7.2 सेमी, AE = 1.8 सेमी और EC = 5.4 सेमी हों, तो AD क्या है?',['21.6 सेमी','2.6 सेमी','2.4 सेमी','3.6 सेमी'],'AD/BD = AE/EC = 1/3, इसलिए AD = 2.4 सेमी।'],
    ['समरूपता की कसौटी','दी गई आकृति में ΔABC ~ ΔPQR किस कसौटी से हैं?',['कोण-कोण-कोण','भुजा-भुजा-भुजा','भुजा-कोण-भुजा','कोण-कोण-भुजा'],'संगत कोण 40°, 80° और 60° हैं, इसलिए कोण-कोण-कोण समरूपता लागू होती है।'],
    ['स्पर्श रेखाएँ','केंद्र O वाले वृत्त पर P से खींची PA और PB स्पर्श रेखाओं के बीच 80° का कोण है। ∠POA क्या है?',['60°','50°','100°','80°'],'समकोण त्रिभुज OAP में ∠APO = 40°, इसलिए ∠POA = 50°।'],
    ['स्पर्श रेखाएँ','किसी वृत्त पर कितनी स्पर्श रेखाएँ हो सकती हैं?',['एक','दो','अनंत','इनमें से कोई नहीं'],'वृत्त के प्रत्येक बिंदु पर एक स्पर्श रेखा होती है, इसलिए उनकी संख्या अनंत है।'],
    ['समांतर स्पर्श रेखाएँ','वृत्त की दो समांतर स्पर्श रेखाओं के बीच की दूरी 18 सेमी है। त्रिज्या क्या है?',['18 सेमी','28 सेमी','36 सेमी','9 सेमी'],'समांतर स्पर्श रेखाओं के बीच की दूरी व्यास है, अतः त्रिज्या 9 सेमी है।'],
    ['त्रिकोणमितीय अनुपात','यदि tan A = 0.75 हो, तो sin A क्या है?',['0.80','0.60','0.25','इनमें से कोई नहीं'],'लंब:आधार = 3:4 लेने पर कर्ण 5 और sin A = 3/5 = 0.60।'],
    ['त्रिकोणमितीय अनुपात','यदि 2 sin θ = √3 हो, तो θ का मान क्या है?',['0°','60°','45°','30°'],'sin θ = √3/2, इसलिए न्यूनकोण θ = 60°।'],
    ['सर्वसमिकाएँ','9 sec² A − 9 tan² A का मान क्या है?',['−9','0','9','इनमें से कोई नहीं'],'sec² A − tan² A = 1, इसलिए मान 9 है।'],
    ['पूरक कोण','यदि sin A = 1/2 और cos B = 1/2 हों, तो A + B क्या है?',['0°','30°','60°','90°'],'A = 30° और B = 60°, इसलिए A + B = 90°।'],
    ['ऊँचाई और दूरी','मीनार से 30 मीटर दूर एक बिंदु से उसके शीर्ष का उन्नयन कोण 45° है। मीनार की ऊँचाई क्या है?',['30 मीटर','15√3 मीटर','10 मीटर','20√3 मीटर'],'tan 45° = ऊँचाई/30 = 1, इसलिए ऊँचाई 30 मीटर है।'],
    ['चाप की लंबाई','7 सेमी त्रिज्या वाले वृत्त में केंद्र पर 60° कोण बनाने वाले चाप की लंबाई क्या है?',['22 सेमी','22/3 सेमी','44 सेमी','44/3 सेमी'],'चाप की लंबाई = 60/360 × 2π × 7 = 22/3 सेमी।'],
    ['त्रिज्यखंड का क्षेत्रफल','14 सेमी त्रिज्या और 90° केंद्रीय कोण वाले त्रिज्यखंड का क्षेत्रफल क्या है?',['102 सेमी²','154 सेमी²','212 सेमी²','308 सेमी²'],'क्षेत्रफल = 90/360 × π × 14² = 154 सेमी²।'],
    ['शंकु','एक शंकु की ऊँचाई 12 सेमी और आधार का व्यास 10 सेमी है। उसकी तिर्यक ऊँचाई क्या है?',['13 सेमी','17 सेमी','5 सेमी','√149 सेमी'],'त्रिज्या 5 सेमी है; l = √(12² + 5²) = 13 सेमी।'],
    ['संयुक्त ठोस','27 सेमी³ आयतन वाले दो घनों को फलक से फलक जोड़ने पर बने ठोस का कुल पृष्ठीय क्षेत्रफल क्या है?',['109.4 सेमी²','126 सेमी²','150 सेमी²','90 सेमी²'],'प्रत्येक घन की भुजा 3 सेमी है। बना घनाभ 6 × 3 × 3 है और कुल पृष्ठीय क्षेत्रफल 90 सेमी² है।'],
    ['अनुभवजन्य संबंध','यदि माध्य = 60 और माध्यिका = 50 हो, तो बहुलक क्या है?',['20','70','30','इनमें से कोई नहीं'],'बहुलक = 3 × माध्यिका − 2 × माध्य = 30।'],
    ['घटना की प्रायिकता','एक निष्पक्ष सिक्का उछालने पर पट आने की प्रायिकता क्या है?',['2/3','1/2','1/5','0'],'चित और पट समान संभावित परिणाम हैं, इसलिए प्रायिकता 1/2 है।']
  ];
...
(() => {
  const q=window.EXAMPREP.questions.filter(x=>x.subject==='Science'&&x.sourceType==='JAC PYQ 2026');
  const rows=[
