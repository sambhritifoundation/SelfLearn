...
- **Accountancy — CBSE Class 11** (full rationalised syllabus): 9 chapters, 43 micro-topic lessons, 71 practice questions with instant bilingual explanations. Chapters 1–2 carry full NCERT-sourced micro-topic notes with a running story (Meena didi's kirana shop), rich formatting and story-based case questions (see `study-material/`).
