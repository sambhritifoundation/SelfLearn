...
1. Need heard or problem noticed.
2. Exact prompt given to the coding assistant.
3. Files changed and what you accepted or rejected.
4. Phone, keyboard, search and cart checks repeated.
5. One piece of partner feedback and the next change.

Keep real seller names, prices, photos and promises off a published version until their owners have reviewed and approved them. A production shop would also need its own fulfilment, payment, privacy and support design; this demo deliberately stops before those features.
